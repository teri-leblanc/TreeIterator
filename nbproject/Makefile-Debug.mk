...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/TreeIteratorVisitor.o \
	${OBJECTDIR}/main.o
...
${OBJECTDIR}/TreeIteratorVisitor.o: TreeIteratorVisitor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TreeIteratorVisitor.o TreeIteratorVisitor.cpp
